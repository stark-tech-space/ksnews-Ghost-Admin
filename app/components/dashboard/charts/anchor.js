...
export default class Anchor extends Component {
  ...
  displayOptions = DISPLAY_OPTIONS.map((options) => ({
    ...options,
    name: this.intl.t(`Manual.Dashboard.${options.name}`),
  }));
  ...
  get hasTrends() {
    return (
      this.dashboardStats.memberCounts !== null && this.dashboardStats.memberCountsTrend !== null
    );
  }
        ...
        xAxes: [
          {
            ...
            ticks: {
              ...
              callback: function (value, index, values) {
                if (index === 0) {
                  document.getElementById('gh-dashboard-anchor-date-start').innerHTML =
                    moment(value).format(DATE_FORMAT);
                }
                if (index === values.length - 1) {
                  document.getElementById('gh-dashboard-anchor-date-end').innerHTML =
                    moment(value).format(DATE_FORMAT);
                }
  ...
  get emptyData() {
    return {
      ...
      data: [
        2925, 3087, 3487, 3910, 3915, 4196, 4566, 4637, 4814, 5108, 5307, 5408, 5799, 6133, 6403,
        6677, 7053, 7111, 7242, 7292, 7596, 7713, 7856, 7886, 8065, 8172, 8361, 8407, 8447, 8496,
      ],
    };
  }
