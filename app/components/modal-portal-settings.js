...
export default ModalComponent.extend({
  ...
  portalPreviewUrl: computed(
    ...
    'settings.{portalName,portalButton,portalButtonIcon,portalButtonSignupText,portalButtonStyle,accentColor,portalPlans.[]}',
    function () {
  ...
  init() {
    ...
    this.buttonStyleOptions = [
      { name: 'icon-and-text', label: this.intl.t('Manual.Components.Icon_and_text') },
      { name: 'icon-only', label: this.intl.t('Manual.Components.Icon_only') },
      { name: 'text-only', label: this.intl.t('Manual.Components.Text_only') },
    ];
    this.availablePages = [
      {
        name: 'signup',
        label: this.intl.t('Manual.Components.Signup'),
      },
      {
        name: 'accountHome',
        label: this.intl.t('Manual.Components.Account'),
      },
      {
        name: 'links',
        label: this.intl.t('Manual.Components.Links'),
      },
    ];
