  ...
  @task(function* () {
    ...
    try {
      ...
      notifications.showAlert(
        this.intl.t('Manual.Login.Please_check_your_email_for_instructions.'),
      ...
      if (!error) {
        return this.set(
          'flowErrors',
          this.intl.t('Manual.Login.We_need_your_email_address_to_reset_your_password!'),
        );
      }
      ...
      if (error && error.payload && error.payload.errors && isEmberArray(error.payload.errors)) {
        ...
        notifications.showAPIError(error, {
          defaultErrorText: this.intl.t(
            'Manual.Login.There_was_a_problem_with_the_reset,_please_try_again.',
          ),
